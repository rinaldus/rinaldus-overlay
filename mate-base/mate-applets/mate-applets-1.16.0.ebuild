...
IUSE="X ipv6 networkmanager +upower gtk3"
...
RDEPEND="${PYTHON_DEPS}
	...
	>=dev-libs/libmateweather-1.16.0:0[gtk3?]
	>=dev-libs/libxml2-2.5:2
	dev-python/pygobject:3
	>=gnome-base/libgtop-2.11.92:2=
	>=mate-base/mate-desktop-1.16:0[gtk3?]
	>=mate-base/mate-panel-1.16:0[gtk3?]
	>=mate-base/mate-settings-daemon-1.16:0[gtk3?]
	...
	x11-libs/pango:0
	>=x11-themes/mate-icon-theme-1.16:0
	virtual/libintl:0
