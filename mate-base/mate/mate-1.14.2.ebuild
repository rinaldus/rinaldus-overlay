...
RDEPEND="
	>=mate-base/mate-desktop-1.14.1:0[gtk3?]
	>=mate-base/mate-menus-1.14:0
	>=mate-base/mate-panel-1.14.1:0[gtk3?]
	>=mate-base/mate-session-manager-1.14:0[gtk3?]
	>=mate-base/mate-settings-daemon-1.14:0[gtk3?]
	>=x11-wm/marco-1.14.2:0[gtk3?]
	base? (
		>=mate-base/caja-1.14.1:0[gtk3?]
		>=mate-base/mate-applets-1.14:0[gtk3?]
		>=mate-base/mate-control-center-1.14:0[gtk3?]
		>=mate-extra/mate-media-1.14:0
		>=x11-misc/mozo-1.14:0
		>=x11-terms/mate-terminal-1.14:0[gtk3?]
	)
