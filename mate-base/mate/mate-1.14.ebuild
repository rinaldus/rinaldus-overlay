...
RDEPEND="
	>=mate-base/mate-desktop-1.14.0:0[gtk3?]
	>=mate-base/mate-menus-1.14:0
	>=mate-base/mate-panel-1.14.0:0[gtk3?]
	>=mate-base/mate-session-manager-1.14.0:0[gtk3?]
	>=mate-base/mate-settings-daemon-1.14.0:0[gtk3?]
	>=x11-wm/marco-1.14.0:0[gtk3?]
	base? (
		>=mate-base/caja-1.14.0:0[gtk3?]
		>=mate-base/mate-applets-1.14.0:0[gtk3?]
		>=mate-base/mate-control-center-1.14.0:0[gtk3?]
		>=mate-extra/mate-media-1.14.0:0
		>=x11-misc/mozo-1.14.0:0
		>=x11-terms/mate-terminal-1.14.0:0[gtk3?]
	)
	bluetooth? ( net-wireless/blueman:0 )
	themes? (
		>=x11-themes/mate-backgrounds-1.14.0:0
		>=x11-themes/mate-icon-theme-1.14.0:0
	)
	extras? (
		>=app-arch/engrampa-1.14.0:0[gtk3?]
		>=app-editors/pluma-1.14:0[gtk3?]
		>=app-text/atril-1.14.0:0[gtk3?]
		!gtk3? ( >=mate-extra/mate-calc-1.8:0 )
		gtk3? ( sci-calculators/galculator )
                >=mate-extra/mate-power-manager-1.14.0:0[gtk3?]
		>=mate-extra/mate-screensaver-1.14.0:0
		>=mate-extra/mate-system-monitor-1.14.0:0
		>=mate-extra/mate-utils-1.14.0:0
		>=media-gfx/eom-1.14.0:0[gtk3?]
	)
"
