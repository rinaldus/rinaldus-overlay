...
RDEPEND="
	...
	>=mate-base/mate-session-manager-1.15.0:0[gtk3?]
	...
	base? (
		...
		>=x11-terms/mate-terminal-1.15.0:0[gtk3?]
	)
	bluetooth? ( net-wireless/blueman:0 )
	themes? (
		>=x11-themes/mate-backgrounds-1.15.0:0
		>=x11-themes/mate-icon-theme-1.15.0:0
	)
	extras? (
		>=app-arch/engrampa-1.15.0:0[gtk3?]
		...
		>=mate-extra/mate-screensaver-1.15.0:0
		>=mate-extra/mate-system-monitor-1.15.0:0[gtk3?]
		>=mate-extra/mate-utils-1.15.0:0
		>=media-gfx/eom-1.15.0:0[gtk3?]
	)
"
